...
def demo(opt):
    """Open csv file wherein you are going write the Predicted Words"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--character', type=str, default='-1234567890객고공과관교구금달대덕동락로배백북소시암연전제주진처학호', help='character label')
